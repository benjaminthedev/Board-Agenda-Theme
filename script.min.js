jQuery(document).ready(function(o){function l(o){var l=/^([\w-]+(?:\.[\w-]+)*)@((?:[\w-]+\.)*\w[\w-]{0,66})\.([a-z]{2,6}(?:\.[a-z]{2})?)$/i;return l.test(o)}o(".log-me-in").click(function(){return o("form#loginform input").removeAttr("disabled").removeClass("disabled"),o('form#loginform input[type="submit"]').fadeIn(),o("#login-popup #forgot").val(""),o("#login-popup .forgot").removeClass("disabled"),o("#login-popup .close-popup").removeClass("visible"),o("#login-popup .login-content").addClass("visible"),o("#login-popup .forgot-content").removeClass("visible"),o("#shade, #login-popup").addClass("visible"),!1}),o("#login-popup .forgot").click(function(){o("#login-popup .forgot-content, #login-popup .login-content").toggleClass("visible"),o("#login-popup #forgot").val(1)}),o("#login-popup form").on("submit",function(a){var e=o(1==o("#login-popup #forgot").val()?"#forgot-email":"#user_login");return l(e.val())?1!=o("#login-popup #forgot").val()&&o("#login-popup #user_pass").val().length<8?(o("#login-popup .login-message").html("Password must be at leat 8 characters"),o("#login-popup #user_pass").addClass("error"),!1):(o("form#loginform input").attr("disabled","disabled").addClass("disabled"),o('form#loginform input[type="submit"]').fadeOut(),o("#login-popup .forgot").addClass("disabled"),o("#login-popup input").removeClass("error"),o.ajax({type:"POST",dataType:"json",url:ajax_login_object.ajaxurl,data:{action:"ajaxlogin",email:o("form#loginform #user_login").val(),"forgot-email":o("form#loginform #forgot-email").val(),password:o("form#loginform #user_pass").val(),security:o("form#loginform #security").val(),forgot:o("form#loginform #forgot").val()},success:function(l){o("form#loginform .login-body.visible .login-message").text(l.message),1==l.loggedin?document.location.href=ajax_login_object.redirecturl:l.close?o("form#loginform .close-popup").addClass("visible"):(o("form#loginform input").removeAttr("disabled").removeClass("disabled"),o('form#loginform input[type="submit"]').fadeIn(),o("#login-popup .forgot").removeClass("disabled"))}}),void a.preventDefault()):(o("#login-popup .login-message").html("Please insert a valid email"),e.addClass("error"),!1)}),o("form#board-agenda-profile").on("submit",function(a){var e=o("form#board-agenda-profile input[required]"),i=o("#leaky-paywall-password1"),r=o("#leaky-paywall-password1"),s=!0;return e.each(function(){""==o(this).val().trim()&&(s=!1,o(this).addClass("error"))}),s=s&&l(o("#leaky-paywall-email").val()),""!=i.val()&&(i.val().length<8||i.val()!=r.val())&&(i.addClass("error"),r.addClass("error"),s=!1),!!s||(a.preventDefault(),!1)}),o(document).ready(function(){o("#login-popup").hasClass("show-me")&&o(".log-me-in").trigger("click")})});
jQuery(document).ready(function(o){function l(o){var l=/^([\w-]+(?:\.[\w-]+)*)@((?:[\w-]+\.)*\w[\w-]{0,66})\.([a-z]{2,6}(?:\.[a-z]{2})?)$/i;return l.test(o)}o(".log-me-in").click(function(){return o("form#loginform input").removeAttr("disabled").removeClass("disabled"),o('form#loginform input[type="submit"]').fadeIn(),o("#login-popup #forgot").val(""),o("#login-popup .forgot").removeClass("disabled"),o("#login-popup .close-popup").removeClass("visible"),o("#login-popup .login-content").addClass("visible"),o("#login-popup .forgot-content").removeClass("visible"),o("#shade, #login-popup").addClass("visible").fadeIn(),!1}),o("#login-popup .forgot").click(function(){o("#login-popup .forgot-content, #login-popup .login-content").toggleClass("visible"),o("#login-popup #forgot").val(1)}),o("#login-popup form").on("submit",function(a){var e=o(1==o("#login-popup #forgot").val()?"#forgot-email":"#user_login");return l(e.val())?1!=o("#login-popup #forgot").val()&&o("#login-popup #user_pass").val().length<8?(o("#login-popup .login-message").html("Password must be at leat 8 characters"),o("#login-popup #user_pass").addClass("error"),!1):(o("form#loginform input").attr("disabled","disabled").addClass("disabled"),o('form#loginform input[type="submit"]').fadeOut(),o("#login-popup .forgot").addClass("disabled"),o("#login-popup input").removeClass("error"),o.ajax({type:"POST",dataType:"json",url:ajax_login_object.ajaxurl,data:{action:"ajaxlogin",email:o("form#loginform #user_login").val(),"forgot-email":o("form#loginform #forgot-email").val(),password:o("form#loginform #user_pass").val(),security:o("form#loginform #security").val(),forgot:o("form#loginform #forgot").val()},success:function(l){o("form#loginform .login-body.visible .login-message").text(l.message),1==l.loggedin?document.location.href=ajax_login_object.redirecturl:l.close?o("form#loginform .close-popup").addClass("visible"):(o("form#loginform input").removeAttr("disabled").removeClass("disabled"),o('form#loginform input[type="submit"]').fadeIn(),o("#login-popup .forgot").removeClass("disabled"))}}),void a.preventDefault()):(o("#login-popup .login-message").html("Please insert a valid email"),e.addClass("error"),!1)}),o("form#board-agenda-profile").on("submit",function(a){var e=o("form#board-agenda-profile input[required]"),i=o("#leaky-paywall-password1"),r=o("#leaky-paywall-password1"),s=!0;return e.each(function(){""==o(this).val().trim()&&(s=!1,o(this).addClass("error"))}),s=s&&l(o("#leaky-paywall-email").val()),""!=i.val()&&(i.val().length<8||i.val()!=r.val())&&(i.addClass("error"),r.addClass("error"),s=!1),!!s||(a.preventDefault(),!1)}),o(document).ready(function(){o("#login-popup").hasClass("show-me")&&o(".log-me-in").trigger("click")})});
!function(e){"use strict";var t=function(){e(".equalize-me").css({height:""}),e(".equalize-parent").each(function(){var t={};e(this).find(".equalize-me").each(function(){var a=e(this).data("compare");t[a]=Math.max(e(this).height(),t[a]||0)});for(var a in t)e(this).find(a).css({height:t[a]})})};e(".sup_alpha_label").click(function(t){var a=e(this).attr("for");e("#"+a);e(".sup_alpha_label").removeClass("alp_selected"),e(this).addClass("alp_selected")}),e(".sng_textarea").keydown(function(t){var a=e(this).val(),s=a.split(" ");s.length>=201?(e(this).attr("disabled","disabled"),e(this).addClass("sng_disabled")):(e(this).removeAttr("disabled"),e(this).removeClass("sng_disabled"))}),e("#views-left .close, #login-popup .close, form#loginform .close-popup, .big-popup .close").click(function(){e("#shade, #views-left, #login-popup, .big-popup").removeClass("visible")}),e("#register-popup .login a").click(function(){e("#register-popup").removeClass("visible")}),e("form.searchform select").change(function(){e("form.searchform").submit()}),e('#resource-searchform input[type="checkbox"]').change(function(){var t=e(this),a=t.is(":checked");"all"==t.attr("name")?e('#resource-searchform input[type="checkbox"]').attr("checked",a):e('#resource-searchform input[name="all"]').attr("checked",!1)}),e(".delete-account").click(function(){var t=e('#delete-account input[type="checkbox"]');t.is(":checked")&&e("#delete-account").submit()}),e('a[href^="#"]').click(function(t){var a=e(this).attr("href");"#"!==a&&e("body, html").animate({scrollTop:e(a).position().top}),t.preventDefault()}),e(".trigger-subscribe").length>0&&e(".button-upgrade").trigger("click"),e(document).ready(function(){t(),e("#register-popup").hasClass("show")&&e("#shade,#register-popup").addClass("visible")}),e(window).bind("resize, load",function(){t()}).load(function(){e("#views-left").length>0&&e("#shade, #views-left").addClass("visible")}),e(document).ready(function(){e(".bxslider").length&&e(".bxslider").bxSlider({auto:!0}),e("#all_featured, #all").click(function(t){console.log("Here we are"),t.preventDefault(),e(this).html("Loading...");var a=e(this).data("ajax"),s=e(this).data("offset"),i=e(this).data("type"),o=e(this).data("nonce"),c=e(this);e.ajax({type:"post",url:a,data:{action:"load_featured_partners",offset:s,type:i,nonce:o},success:function(t){""!==t?c.fadeOut(400,"swing",function(a){e("#featured_container").append(t)}):c.html("No more posts to display")},error:function(e){c.html("No more posts to display")}})})}),e(".resource-category").click(function(){e(".resource-category-list").toggleClass("visible")})}(jQuery);
!function(e){"use strict";var t=function(){e(".equalize-me").css({height:""}),e(".equalize-parent").each(function(){var t={};e(this).find(".equalize-me").each(function(){var c=e(this).data("compare");t[c]=Math.max(e(this).height(),t[c]||0)});for(var c in t)e(this).find(c).css({height:t[c]})})};e("#views-left .close, #login-popup .close, form#loginform .close-popup").click(function(){e("#shade, #views-left, #login-popup").fadeOut()}),e("form.searchform select").change(function(){e("form.searchform").submit()}),e('#resource-searchform input[type="checkbox"]').change(function(){var t=e(this),c=t.is(":checked");"all"==t.attr("name")?e('#resource-searchform input[type="checkbox"]').attr("checked",c):e('#resource-searchform input[name="all"]').attr("checked",!1)}),e(".delete-account").click(function(){var t=e('#delete-account input[type="checkbox"]');t.is(":checked")&&e("#delete-account").submit()}),e('a[href^="#"]').click(function(t){var c=e(this).attr("href");"#"!==c&&e("body, html").animate({scrollTop:e(c).position().top}),t.preventDefault()}),e(document).ready(function(){t()}),e(window).bind("resize, load",function(){t()}).load(function(){e("#views-left").length>0&&e("#shade, #views-left").fadeIn()})}(jQuery);
