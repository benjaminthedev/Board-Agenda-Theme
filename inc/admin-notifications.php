...
/**
 * Show all the notifications for the admins - Disabled now as we use LeakyPay Wall for registrations
 * https://boardagenda.com/wp-admin/edit.php?post_type=notifications
 *
 */
