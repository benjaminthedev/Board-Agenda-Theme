  ...
  $insights_sponsor_link = get_field( 'sponsor_link', $category_ids['insights'] ); 
	...
	<div class="wrap top-bottom-margin first mobile-view-hide">
	    ...
	    <!-- Home Page Slider Begin -->
			...
			<?php echo do_shortcode('[recent_post_slider design="design-1" category="4"]'); ?>
...
<!-- /******************* Latest Video Content Start *********************** -->

    


<!-- /******************* Latest Video Content End *********************** -->



<!-- Note: this content is in VideoContentTemplatePartFromHomePage.php when client wants it back in! -->
